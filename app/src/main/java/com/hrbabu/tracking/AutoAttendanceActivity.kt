...
import com.hrbabu.tracking.databinding.ActivityAutoAttendanceBinding
...
class AutoAttendanceActivity : BaseActivity() {

    lateinit var binding: ActivityAutoAttendanceBinding
    private lateinit var homeActivityHelper: AutoAttendanceActivityHelper
    companion object {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAutoAttendanceBinding.inflate(layoutInflater)
...
//        binding.edEmpId.doOnTextChanged {
//            text, start, before, count ->
//            {
//                Log.e("TextChanged", "Text changed: $text   $count")
//                if(count==0){
//                    binding.edEmpId.error = "Employee ID cannot be empty"
//                }
//            }
//        }
...
//        binding.llLocation.visibility= View.VISIBLE
        ...
        binding.tvDate.text = DateFormat.format("dd MMM, EEEE", Date())
...
////                    } else {
////
////                        pendingLocation =  Location(LocationManager.GPS_PROVIDER).apply {
////                            latitude = 0.0
////                            longitude = 0.0
////                        }
////                        openCameraLauncher.launch(Intent(this@AutoAttendanceActivity, CustomCamera::class.java))
...
//                callback(null)
     ...
     */
    private fun captureAccurateLocation(callback: (Location?) -> Unit) {
...
//                    val addresses =
//                        geocoder.getFromLocation(pendingLocation?.latitude ?: 0.0, pendingLocation?.longitude ?: 0.0, 1)
...
//    fun setButtonStateManual(button: Button , state: ButtonState) {
//        when (state) {
...
//                button.setBackgroundColor(Color.parseColor("#BDBDBD")) // Gray
//                button.setTextColor(Color.WHITE)
//            }
//            ButtonState.CHECK_OUT -> {
//                button.text = "Check Out"
//                button.setBackgroundColor(Color.parseColor("#FF5252")) // Red
//                button.setTextColor(Color.WHITE)
//            }
//        }
//    }
